"""Access Control, Door and Credential (Profile A/C) operations for the synchronous ONVIF client."""
...
class AccessControlOperations(SyncTransport):
    """Access Control, Door and Credential (Profile A/C) operations, mixed into :class:`~onveef.client.OnvifClient`."""
    ...
    def get_access_points(self, *, tokens: list[str]) -> dict[str, Any]:
    ...
    def get_doors(self, *, tokens: list[str]) -> dict[str, Any]:
    ...
    def get_credentials(self, *, tokens: list[str]) -> list[dict[str, Any]]:
    ...
    def get_schedules(self, *, tokens: list[str]) -> list[dict[str, Any]]:
    ...
    def get_schedule_state(self, *, token: str) -> dict[str, Any]:
    ...
    def get_special_day_group_info_list(
        self, *, limit: int | None = None, start_reference: str = ""
    ) -> dict[str, Any]:
    ...
    def get_special_day_groups(self, *, tokens: list[str]) -> list[dict[str, Any]]:
    ...
    def delete_special_day_group(self, *, token: str) -> None:
    ...
    def get_access_profile_info_list(
        self, *, limit: int | None = None, start_reference: str = ""
    ) -> dict[str, Any]:
    ...
    def get_access_profiles(self, *, tokens: list[str]) -> list[dict[str, Any]]:
    ...
    def delete_access_profile(self, *, token: str) -> None:
