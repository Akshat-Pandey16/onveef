"""Recording, Replay and Search (Profile G) operations for the synchronous ONVIF client."""
...
class RecordingOperations(SyncTransport):
    """Recording, Replay and Search (Profile G) operations, mixed into :class:`~onveef.client.OnvifClient`."""
    ...
    def get_track_configuration(self, *, recording_token: str, track_token: str) -> dict[str, Any]:
    ...
    def create_track(self, *, recording_token: str, track_type: str, description: str = "") -> str:
    ...
    def delete_track(self, *, recording_token: str, track_token: str) -> None:
    ...
    def get_recording_job_state(self, *, job_token: str) -> dict[str, Any]:
    ...
    def get_search_state(self, *, search_token: str) -> str:
